...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="a_login.jsp"><span>Key Server </span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style8">Key Server  LogIn</h2>
		  <p>&nbsp;</p>




<form name="s" action="k_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
