...
<table width="561" height="395" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						String utype=(String)application.getAttribute("utype");
						
						String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13;
						int i=0;
						try 
						{
						   	String query="select * from user where name='"+owner+"' and utype='"+utype+"' "; 
          ...
          <p>&nbsp;</p>
		  <p align="right"><a href="o_main.jsp" class="style9"> Back </a></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="o_main.jsp">User Main</a></li>
