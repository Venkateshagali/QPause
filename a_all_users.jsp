...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style8"> View All Users and Authorize </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="90" bgcolor="#9eb8dd"><div align="center" class="style10 style11 style12">Client Image</div></td>
           <td width="115" bgcolor="#9eb8dd"><div align="center" class="style10 style11 style12">Client Name</div></td>
           <td width="97" bgcolor="#9eb8dd"><div align="center" class="style10 style11 style12">Client Full Details</div></td>
		   <td width="67" bgcolor="#9eb8dd"><div align="center" class="style10 style11 style12">Status</div></td>
		 </tr>
 ...
 try 
	{		
		...
		%>
                    ...
                    <tr>
                      <td bgcolor="#00FFFF"><div align="center" class="style16 style10 style11 style13"><%=j%></div></td>
                      <td bgcolor="#00FFFF" align="center"><input  name="image" type="image" style="width:110px; height:90px;" src="u_Pic.jsp?id=<%=i%>" /></td>
					  <td bgcolor="#00FFFF"><div align="center" class="style16 style10 style11 style13"><%=s2%></div></td>
					  <td width="108" align="center" bgcolor="#00FFFF"><a href="a_user_profile.jsp?user=<%=s2%>&type=<%="one"%>" class="style16 style10 style11 style13">Click here</a></td>
					  <%
              ...
              <td bgcolor="#00FFFF"><div align="center" class="style16 style10 style11 style13">
                <a href="u_Status.jsp?id=<%=i%>" class="style17 style14">waiting</a> </div></td>
              <%
						}
						else
						{
