...
<%
					...
					String gender=null;
					String pincode=null,utype=null;
					...
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,image,status,utype,hc) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			<%
						...
						String str1="waiting";
					PreparedStatement ps1=connection.prepareStatement("insert into backupuser(name,pass,email,mobile,addr,dob,gender,pin,location,image,status,utype,hc) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						ps1.setBinaryStream(10, (InputStream)fs, (int)(file1.length()));	
						ps1.setString(11,str1);
						ps1.setString(12,utype);
						ps1.setString(13,h1);
						...
						{
							fs1 = (FileInputStream)list.get(0);
							ps1.setBinaryStream(10,fs1,fs1.available());
						}
