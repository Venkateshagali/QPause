...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style8"> Welcome to User Main : <span class="style9"> <%=application.getAttribute("user")%> </span></h2>
		  
<p><img src="images/User.jpg" width="614" height="208" /></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style10">
			...
			<li><a href="u_search_req.jsp"> Request Secret Key</a></li>
			<li><a href="u_Search.jsp"> Search Datasets</a></li>
			<li><a href="u_DownloadDataset.jsp"> Download Dataset</a></li>
