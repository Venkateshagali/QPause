...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style8">CSP LogIn</h2>
		  <p>&nbsp;</p>
...
<form name="s" action="a_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
    ...
    <table align="center" border="1" width="51%" height="146">
      ...
      <tr>
        <td width="48%" height="25" bgcolor="#78bbe6" class="style5 style2"> <span class="style9 style2 style4 style3 style6">Name</span></td>
